...
fun! <sid>hi(group, fg, bg, attr, sp)
  if !empty(a:fg)
    exec "hi " . a:group . " guifg=" . a:fg.gui . " ctermfg=" . (g:itzikode_term256 ? a:fg.cterm256 : a:fg.cterm)
  endif
  if !empty(a:bg)
    exec "hi " . a:group . " guibg=" . a:bg.gui . " ctermbg=" . (g:itzikode_term256 ? a:bg.cterm256 : a:bg.cterm)
  endif
  if a:attr != ""
...
if !exists("g:itzikode_conservative")
    let g:itzikode_conservative=0
endif

" Italicized comments
if !exists("g:itzikode_italics")
    let g:itzikode_italics=0
endif
...
if g:itzikode_conservative | let s:cdLightBlue = s:cdFront | endif
...
if g:itzikode_conservative | let s:cdLightRed = s:cdOrange | endif
let s:cdYellowOrange = {'gui': '#D7BA7D', 'cterm': s:cterm0A, 'cterm256': '179'}
let s:cdYellow = {'gui': '#DCDCAA', 'cterm': s:cterm0A, 'cterm256': '187'}
if g:itzikode_conservative | let s:cdYellow = s:cdFront | endif
let s:cdPink = {'gui': '#C586C0', 'cterm': s:cterm0E, 'cterm256': '176'}
if g:itzikode_conservative | let s:cdPink = s:cdBlue | endif
...
if g:itzikode_italics | call <sid>hi('Comment', s:cdGreen, {}, 'italic', {}) | else | call <sid>hi('Comment', s:cdGreen, {}, 'none', {}) | endif
...
if g:itzikode_italics | call <sid>hi('SpecialComment', s:cdGreen, {}, 'italic', {}) | else | call <sid>hi('SpecialComment', s:cdGreen, {}, 'none', {}) | endif
